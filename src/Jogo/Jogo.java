...
public class Jogo {
    ...
    private ArrayList<Sistema> desalinhados;
   ...
   // private boolean interspecies;
    ...
    public Jogo(){
        ...
        this.proximos = Sistema.Proximos();
        this.strike = false;
        this.diplomacy = false;
        this.longinquos = Sistema.Longinquos();
   ...
   // public boolean getInterSpeciesCommerce(){ return this.interspecies;}
    ...
    public ArrayList<Sistema> getProximos(){
        return this.proximos;
    }
    public ArrayList<Sistema> getLonginquos(){
        return this.longinquos;
    }   
    public ArrayList<Carta> getEventos(){return this.eventos;}
    public ArrayList<Sistema> getDesalinhas(){return this.desalinhados;}
    public Jogador getPlayer(){return this.Player;}
    ...
    public void setRelatorioCombat(boolean r, Sistema s, int n){
        if(!r){
    ...
    public void setMensagemSistema(String s){this.MensagemSistema += s + "\n";}
